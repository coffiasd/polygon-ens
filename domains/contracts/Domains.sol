...
contract Domains is ERC721URIStorage, Ownable {
    ...
    constructor(string memory tld) ERC721("Lch Name Service", "NNS") {
        _tld = tld;
        console.log("ME AND MY BROOOOO IS GOING TO CHANGE THE WORLD!!!");
    }

    function changeTld(string memory tld) public onlyOwner {
        _tld = tld;
    }

    // check the price of each domain
